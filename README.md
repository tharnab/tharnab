...
* 🔬 **Unsupervised Machine Learning:** Actively working on ML projects focused on pattern recognition, anomaly detection, and data clustering using `Scikit-Learn`, `Pandas`, and `NumPy`.
* 🚀 **Future Roadmap:** Expanding my knowledge into **Deep Learning**, Neural Networks, and advanced AI application integration.
* 📈 **DSA & Problem Solving:** Actively practicing algorithms and data structures on [LeetCode](https://leetcode.com/u/tharnab/).
...
⚡ *Fun Fact: Always eager to merge Full-Stack Development with AI/ML to create smart, real-world applications!*
